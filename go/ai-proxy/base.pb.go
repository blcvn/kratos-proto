...
type ChatMessage struct {
	...
	Parts         []*ChatMessagePart     `protobuf:"bytes,3,rep,name=parts,proto3" json:"parts,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ChatMessage) GetParts() []*ChatMessagePart {
	if x != nil {
		return x.Parts
	}
	return nil
...
func (x *BinaryPart) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BinaryPart) ProtoMessage() {}

func (x *BinaryPart) ProtoReflect() protoreflect.Message {
	mi := &file_ai_proxy_base_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BinaryPart.ProtoReflect.Descriptor instead.
func (*BinaryPart) Descriptor() ([]byte, []int) {
	return file_ai_proxy_base_proto_rawDescGZIP(), []int{7}
}

func (x *BinaryPart) GetMimeType() string {
	if x != nil {
		return x.MimeType
	}
	return ""
...
func (x *BinaryPart) GetData() []byte {
	if x != nil {
		return x.Data
	}
	return nil
...
type ChatMessagePart struct {
	...
	//
	//	*ChatMessagePart_Text
	//	*ChatMessagePart_ImageUrl
	//	*ChatMessagePart_Binary
	Kind          isChatMessagePart_Kind `protobuf_oneof:"kind"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ChatMessagePart) GetKind() isChatMessagePart_Kind {
	if x != nil {
		return x.Kind
	}
	return nil
...
func (x *ChatMessagePart) GetText() *TextPart {
	if x != nil {
		if x, ok := x.Kind.(*ChatMessagePart_Text); ok {
			return x.Text
		}
	}
	return nil
...
func (x *ChatMessagePart) GetImageUrl() *ImageURLPart {
	if x != nil {
		if x, ok := x.Kind.(*ChatMessagePart_ImageUrl); ok {
			return x.ImageUrl
		}
	}
	return nil
...
func (x *ChatMessagePart) GetBinary() *BinaryPart {
	if x != nil {
		if x, ok := x.Kind.(*ChatMessagePart_Binary); ok {
			return x.Binary
		}
	}
	return nil
...
type isChatMessagePart_Kind interface {
	isChatMessagePart_Kind()
}

type ChatMessagePart_Text struct {
	Text *TextPart `protobuf:"bytes,1,opt,name=text,proto3,oneof"`
}

type ChatMessagePart_ImageUrl struct {
	ImageUrl *ImageURLPart `protobuf:"bytes,2,opt,name=image_url,json=imageUrl,proto3,oneof"`
}

type ChatMessagePart_Binary struct {
	Binary *BinaryPart `protobuf:"bytes,3,opt,name=binary,proto3,oneof"`
}

func (*ChatMessagePart_Text) isChatMessagePart_Kind() {}

func (*ChatMessagePart_ImageUrl) isChatMessagePart_Kind() {}

func (*ChatMessagePart_Binary) isChatMessagePart_Kind() {}
...
func (x *PromptCacheConfig) Reset() {
	*x = PromptCacheConfig{}
...
func (x *PromptCacheConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PromptCacheConfig) ProtoMessage() {}

func (x *PromptCacheConfig) ProtoReflect() protoreflect.Message {
	mi := &file_ai_proxy_base_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PromptCacheConfig.ProtoReflect.Descriptor instead.
func (*PromptCacheConfig) Descriptor() ([]byte, []int) {
	return file_ai_proxy_base_proto_rawDescGZIP(), []int{9}
}

func (x *PromptCacheConfig) GetEnabled() bool {
	if x != nil {
		return x.Enabled
	}
	return false
...
func (x *PromptCacheConfig) GetTtl() string {
	if x != nil {
		return x.Ttl
	}
	return ""
...
func (x *PromptCacheConfig) GetScope() string {
	if x != nil {
		return x.Scope
	}
	return ""
...
type ThinkingConfig struct {
	...
	ReturnThinking     bool                   `protobuf:"varint,3,opt,name=return_thinking,json=returnThinking,proto3" json:"return_thinking,omitempty"`
	StreamThinking     bool                   `protobuf:"varint,4,opt,name=stream_thinking,json=streamThinking,proto3" json:"stream_thinking,omitempty"`
	InterleaveThinking bool                   `protobuf:"varint,5,opt,name=interleave_thinking,json=interleaveThinking,proto3" json:"interleave_thinking,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *ThinkingConfig) GetMode() string {
	if x != nil {
		return x.Mode
	}
	return ""
...
func (x *ThinkingConfig) GetBudgetTokens() int32 {
	if x != nil {
...
func (x *ThinkingConfig) GetReturnThinking() bool {
	if x != nil {
		return x.ReturnThinking
	}
	return false
}

func (x *ThinkingConfig) GetStreamThinking() bool {
	if x != nil {
		return x.StreamThinking
	}
	return false
}

func (x *ThinkingConfig) GetInterleaveThinking() bool {
	if x != nil {
...
type CompletionRequest struct {
	...
	PromptCache   *PromptCacheConfig     `protobuf:"bytes,9,opt,name=prompt_cache,json=promptCache,proto3" json:"prompt_cache,omitempty"`
	Thinking      *ThinkingConfig        `protobuf:"bytes,10,opt,name=thinking,proto3" json:"thinking,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CompletionRequest) GetPromptCache() *PromptCacheConfig {
	if x != nil {
...
func (x *CompletionRequest) GetThinking() *ThinkingConfig {
	if x != nil {
		return x.Thinking
	}
	return nil
...
func (x *CompletionResponse) Reset() {
	*x = CompletionResponse{}
	mi := &file_ai_proxy_base_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CompletionResponse) Descriptor() ([]byte, []int) {
	return file_ai_proxy_base_proto_rawDescGZIP(), []int{12}
}
...
func (x *CompletionChunk) Reset() {
	*x = CompletionChunk{}
	mi := &file_ai_proxy_base_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CompletionChunk) Descriptor() ([]byte, []int) {
	return file_ai_proxy_base_proto_rawDescGZIP(), []int{13}
}
...
func (x *ProviderHealth) Reset() {
	*x = ProviderHealth{}
	mi := &file_ai_proxy_base_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ProviderHealth) Descriptor() ([]byte, []int) {
	return file_ai_proxy_base_proto_rawDescGZIP(), []int{14}
}
...
const file_ai_proxy_base_proto_rawDesc = "" +
	...
	"\x0fChatMessagePart\x12*\n" +
	"\x04text\x18\x01 \x01(\v2\x14.aiproxy.v1.TextPartH\x00R\x04text\x127\n" +
	"\timage_url\x18\x02 \x01(\v2\x18.aiproxy.v1.ImageURLPartH\x00R\bimageUrl\x120\n" +
	"\x06binary\x18\x03 \x01(\v2\x16.aiproxy.v1.BinaryPartH\x00R\x06binaryB\x06\n" +
	"\x04kind\"U\n" +
	"\x11PromptCacheConfig\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12\x10\n" +
	"\x03ttl\x18\x02 \x01(\tR\x03ttl\x12\x14\n" +
	"\x05scope\x18\x03 \x01(\tR\x05scope\"\xcc\x01\n" +
	"\x0eThinkingConfig\x12\x12\n" +
	"\x04mode\x18\x01 \x01(\tR\x04mode\x12#\n" +
	"\rbudget_tokens\x18\x02 \x01(\x05R\fbudgetTokens\x12'\n" +
	"\x0freturn_thinking\x18\x03 \x01(\bR\x0ereturnThinking\x12'\n" +
	"\x0fstream_thinking\x18\x04 \x01(\bR\x0estreamThinking\x12/\n" +
	"\x13interleave_thinking\x18\x05 \x01(\bR\x12interleaveThinking\"\xe5\x03\n" +
	...
	"\bmetadata\x18\a \x03(\v2+.aiproxy.v1.CompletionRequest.MetadataEntryR\bmetadata\x12@\n" +
	"\fprompt_cache\x18\t \x01(\v2\x1d.aiproxy.v1.PromptCacheConfigR\vpromptCache\x126\n" +
	"\bthinking\x18\n" +
	" \x01(\v2\x1a.aiproxy.v1.ThinkingConfigR\bthinking\x1a;\n" +
...
var file_ai_proxy_base_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_ai_proxy_base_proto_goTypes = []any{
	...
	(*TextPart)(nil),             // 9: aiproxy.v1.TextPart
	(*ImageURLPart)(nil),         // 10: aiproxy.v1.ImageURLPart
	(*BinaryPart)(nil),           // 11: aiproxy.v1.BinaryPart
	(*ChatMessagePart)(nil),      // 12: aiproxy.v1.ChatMessagePart
	(*PromptCacheConfig)(nil),    // 13: aiproxy.v1.PromptCacheConfig
	(*ThinkingConfig)(nil),       // 14: aiproxy.v1.ThinkingConfig
	(*CompletionRequest)(nil),    // 15: aiproxy.v1.CompletionRequest
	...
	nil,                          // 19: aiproxy.v1.CompletionRequest.MetadataEntry
...
var file_ai_proxy_base_proto_depIdxs = []int32{
	...
	12, // 3: aiproxy.v1.ChatMessage.parts:type_name -> aiproxy.v1.ChatMessagePart
	9,  // 4: aiproxy.v1.ChatMessagePart.text:type_name -> aiproxy.v1.TextPart
	10, // 5: aiproxy.v1.ChatMessagePart.image_url:type_name -> aiproxy.v1.ImageURLPart
	11, // 6: aiproxy.v1.ChatMessagePart.binary:type_name -> aiproxy.v1.BinaryPart
	8,  // 7: aiproxy.v1.CompletionRequest.messages:type_name -> aiproxy.v1.ChatMessage
	19, // 8: aiproxy.v1.CompletionRequest.metadata:type_name -> aiproxy.v1.CompletionRequest.MetadataEntry
	13, // 9: aiproxy.v1.CompletionRequest.prompt_cache:type_name -> aiproxy.v1.PromptCacheConfig
	14, // 10: aiproxy.v1.CompletionRequest.thinking:type_name -> aiproxy.v1.ThinkingConfig
	20, // 11: aiproxy.v1.CompletionResponse.created_at:type_name -> google.protobuf.Timestamp
	1,  // 12: aiproxy.v1.ProviderHealth.status:type_name -> aiproxy.v1.ProviderStatus
	20, // 13: aiproxy.v1.ProviderHealth.last_check:type_name -> google.protobuf.Timestamp
...
func file_ai_proxy_base_proto_init() {
	...
	file_ai_proxy_base_proto_msgTypes[8].OneofWrappers = []any{
		(*ChatMessagePart_Text)(nil),
		(*ChatMessagePart_ImageUrl)(nil),
		(*ChatMessagePart_Binary)(nil),
	}
	type x struct{}
