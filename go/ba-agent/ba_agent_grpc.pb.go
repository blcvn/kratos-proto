...
const (
	...
	BAAgentService_StreamEvents_FullMethodName          = "/baagent.v1.BAAgentService/StreamEvents"
	BAAgentService_CancelStream_FullMethodName          = "/baagent.v1.BAAgentService/CancelStream"
)
...
type BAAgentServiceClient interface {
	...
	StreamEvents(ctx context.Context, in *StreamRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[StreamEvent], error)
...
func (c *bAAgentServiceClient) StreamEvents(ctx context.Context, in *StreamRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[StreamEvent], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &BAAgentService_ServiceDesc.Streams[2], BAAgentService_StreamEvents_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type BAAgentService_StreamEventsClient = grpc.ServerStreamingClient[StreamEvent]
...
func (c *bAAgentServiceClient) CancelStream(ctx context.Context, in *CancelStreamRequest, opts ...grpc.CallOption) (*CancelStreamResponse, error) {
	...
	err := c.cc.Invoke(ctx, BAAgentService_CancelStream_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BAAgentServiceServer interface {
	...
	// V3 Streaming — Delivery V3
	StreamEvents(*StreamRequest, grpc.ServerStreamingServer[StreamEvent]) error
...
func (UnimplementedBAAgentServiceServer) StreamEvents(*StreamRequest, grpc.ServerStreamingServer[StreamEvent]) error {
...
func _BAAgentService_StreamEvents_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(BAAgentServiceServer).StreamEvents(m, &grpc.GenericServerStream[StreamRequest, StreamEvent]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type BAAgentService_StreamEventsServer = grpc.ServerStreamingServer[StreamEvent]
...
func _BAAgentService_CancelStream_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BAAgentService_CancelStream_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
